...
#quilo excedente. João precisa que você faça um programa que leia a variável peso 
...
if peso > pesoLimite:
    total = peso + pesoLimite
    excesso = peso - pesoLimite
    multa = excesso * valorMulta
    print("O peso total foi de: ", total,"kg com excesso de: ", excesso,"kg e a multa foi no valor de: R$", multa)
